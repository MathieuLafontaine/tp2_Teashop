...
abstract class CRUD extends \PDO
{
    ...
    final public function selectTransaction($field = null, $order = 'asc')
    {
        if ($field == null) {
            $field = $this->primaryKey;
        }
        ...
        $sql = "SELECT client.name AS client_name,
            paymentmethod.name AS paymentmethod_name,
            transaction.date,
            ...
            INNER JOIN article ON transaction.id = article.transaction_id
            INNER JOIN tea ON article.tea_id = tea.id
            INNER JOIN paymentmethod ON paymentmethod_id = paymentmethod.id
